...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-dark-400 mt-1">Harici servis ve portal entegrasyonlarını yönetin</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach($integrations as $integration)
                @if(in_array($integration['id'], ['sahibinden', 'hepsiemlak', 'emlakjet']))
                    <div class="bg-dark-700 rounded-xl p-5 border border-dark-600 hover:border-{{ $integration['color'] }}-500/50 transition-colors">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-dark-400 text-sm">{{ $integration['description'] }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button class="px-3 py-1.5 bg-dark-600 text-dark-300 rounded-lg text-sm hover:bg-dark-500 transition-colors">
                                Ayarlar
                            </button>
                        </div>
    ...
    <div class="bg-gradient-to-br from-purple-900/30 to-dark-800 rounded-xl border border-purple-500/30 p-6">
        <div class="flex items-center space-x-3 mb-4">
            ...
            <div>
                ...
                <p class="text-dark-400 text-sm">Harici uygulamalar için API anahtarları</p>
            </div>
        </div>
        ...
        <div class="bg-dark-800/50 rounded-lg p-4 mb-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-dark-400 text-sm mb-1">API Anahtarı</p>
        ...
        <div class="flex items-center space-x-3">
            <button class="px-4 py-2 bg-dark-700 text-dark-300 rounded-lg text-sm hover:bg-dark-600 transition-colors">
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-dark-400 text-sm">Gelen webhook istekleri için URL'ler</p>
                </div>
            </div>
        ...
        <div class="space-y-3">
            <div class="bg-dark-700 rounded-lg p-4 flex items-center justify-between">
                <div>
                    ...
                    <code class="text-dark-400 text-sm">{{ url('/api/webhooks/portal-sync') }}</code>
                </div>
                <div class="flex items-center space-x-2">
                    <span class="w-2 h-2 bg-green-500 rounded-full"></span>
                    <span class="text-green-400 text-sm">Aktif</span>
            ...
            <div class="bg-dark-700 rounded-lg p-4 flex items-center justify-between">
                <div>
                    <p class="text-white font-medium">Lead Capture Webhook</p>
                    <code class="text-dark-400 text-sm">{{ url('/api/webhooks/lead-capture') }}</code>
                </div>
                <div class="flex items-center space-x-2">
                    <span class="w-2 h-2 bg-green-500 rounded-full"></span>
                    <span class="text-green-400 text-sm">Aktif</span>
            ...
            <div class="bg-dark-700 rounded-lg p-4 flex items-center justify-between">
                <div>
                    ...
                    <code class="text-dark-400 text-sm">{{ url('/api/webhooks/call-events') }}</code>
                </div>
                <div class="flex items-center space-x-2">
                    <span class="w-2 h-2 bg-gray-500 rounded-full"></span>
                    <span class="text-gray-400 text-sm">Pasif</span>
