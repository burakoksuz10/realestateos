...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-white">İlan Düzenle</h1>
            <p class="text-dark-400 mt-1">{{ $listing->reference_no }} - {{ $listing->title }}</p>
        </div>
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('admin.listings.show', $listing) }}" class="px-4 py-2 bg-dark-700 text-dark-300 rounded-lg hover:bg-dark-600 transition-colors">
    ...
    <form action="{{ route('admin.listings.update', $listing) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-dark-800 rounded-xl border border-dark-700 p-6">
            <h2 class="text-lg font-semibold text-white mb-4">Temel Bilgiler</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" value="{{ old('title', $listing->title) }}" required
                        class="w-full px-4 py-2.5 bg-dark-700 border border-dark-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-primary-500 @error('title') border-red-500 @enderror">
                    @error('title')
                ...
                <div>
                    ...
                    <select name="listing_type" required
                        class="w-full px-4 py-2.5 bg-dark-700 border border-dark-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <select name="type" required
                        class="w-full px-4 py-2.5 bg-dark-700 border border-dark-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
                        <option value="apartment" {{ old('type', $listing->type) == 'apartment' ? 'selected' : '' }}>Daire</option>
                        <option value="villa" {{ old('type', $listing->type) == 'villa' ? 'selected' : '' }}>Villa</option>
                        <option value="office" {{ old('type', $listing->type) == 'office' ? 'selected' : '' }}>Ofis</option>
                        <option value="land" {{ old('type', $listing->type) == 'land' ? 'selected' : '' }}>Arsa</option>
                        <option value="shop" {{ old('type', $listing->type) == 'shop' ? 'selected' : '' }}>Dükkan</option>
                        <option value="warehouse" {{ old('type', $listing->type) == 'warehouse' ? 'selected' : '' }}>Depo</option>
                    </select>
                </div>

                <div>
                    <label class="block text-sm font-medium text-dark-300 mb-2">Kategori *</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="4"
                        class="w-full px-4 py-2.5 bg-dark-700 border border-dark-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-primary-500">{{ old('description', $listing->description) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <!-- Fiyat Bilgileri -->
        <div class="bg-dark-800 rounded-xl border border-dark-700 p-6">
            <h2 class="text-lg font-semibold text-white mb-4">Fiyat Bilgileri</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-dark-300 mb-2">Danışman *</label>
        ...
        <!-- Konum Bilgileri -->
        <div class="bg-dark-800 rounded-xl border border-dark-700 p-6">
            <h2 class="text-lg font-semibold text-white mb-4">Konum Bilgileri</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="district" value="{{ old('district', $listing->district) }}" required
                        class="w-full px-4 py-2.5 bg-dark-700 border border-dark-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
                </div>
                ...
                <div class="md:col-span-3">
                    ...
                    <textarea name="address" rows="2"
                        class="w-full px-4 py-2.5 bg-dark-700 border border-dark-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-primary-500">{{ old('address', $listing->address) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-dark-800 rounded-xl border border-dark-700 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-dark-300 mb-2">Salon Sayısı</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-dark-300 mb-2">Isıtma Tipi</label>
                ...
                <div class="flex items-center">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="is_furnished" value="1" {{ old('is_furnished', $listing->is_furnished) ? 'checked' : '' }}
                            class="w-5 h-5 rounded border-dark-600 bg-dark-700 text-primary-500 focus:ring-primary-500">
                        <span class="ml-2 text-dark-300">Eşyalı</span>
                    </label>
                </div>
            </div>
        </div>
        ...
        <!-- Versiyon Notu -->
        <div class="bg-dark-800 rounded-xl border border-dark-700 p-6">
            <h2 class="text-lg font-semibold text-white mb-4">Değişiklik Notu</h2>
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('admin.listings.index') }}" class="px-6 py-2.5 bg-dark-700 text-dark-300 rounded-lg hover:bg-dark-600 transition-colors">
                İptal
            </a>
