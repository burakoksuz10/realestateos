...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.deals.show', $deal) }}" class="px-4 py-2 bg-gray-100 dark:bg-dark-700 hover:bg-gray-200 dark:hover:bg-dark-600 text-gray-700 dark:text-white rounded-xl transition-colors flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Komisyon Özeti</h2>
                <div class="space-y-4">
                    <div class="flex justify-between items-center py-3 border-b border-gray-200 dark:border-dark-700/50">
                        <span class="text-gray-500 dark:text-dark-400">Satış Değeri</span>
                        <span class="text-white font-semibold text-lg">₺{{ number_format($deal->value ?? 0, 0, ',', '.') }}</span>
                    </div>
                    <div class="flex justify-between items-center py-3 border-b border-gray-200 dark:border-dark-700/50">
                        <span class="text-gray-500 dark:text-dark-400">Komisyon Oranı</span>
                    ...
                    <div class="flex justify-between items-center py-3 border-b border-gray-200 dark:border-dark-700/50">
                        <span class="text-gray-500 dark:text-dark-400">Toplam Komisyon</span>
                        <span class="text-primary-400 font-bold text-xl">₺{{ number_format($deal->commission_amount ?? 0, 0, ',', '.') }}</span>
                    </div>
                    @if($deal->is_partner_deal)
                    <div class="flex justify-between items-center py-3 border-b border-gray-200 dark:border-dark-700/50">
                        <span class="text-gray-500 dark:text-dark-400">Ortak Ofis Payı</span>
            ...
            @if($deal->is_partner_deal)
            <div class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Ortak Satış Bilgileri</h2>
                <div class="space-y-3">
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-dark-400 text-sm">Ortak Ofis</span>
                        <span class="text-white text-sm">{{ $deal->partnerOffice->name ?? '-' }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-dark-400 text-sm">Ortak Danışman</span>
        ...
        <div class="space-y-6">
            <div class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6">
                <h2 class="text-sm font-medium text-gray-500 dark:text-dark-400 uppercase tracking-wider mb-4">Satış Durumu</h2>
                <div class="space-y-2">
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-dark-400 text-sm">Danışman</span>
            ...
            <div class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6">
                <a href="{{ route('admin.deals.show', $deal) }}" class="w-full px-4 py-2.5 bg-gradient-to-r from-sky-400 to-blue-600 hover:from-sky-500 hover:to-blue-700 text-white font-medium rounded-xl transition-colors block text-center">
                    Satışa Git
                </a>
            </div>
        </div>
