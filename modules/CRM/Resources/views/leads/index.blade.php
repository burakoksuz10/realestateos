...
@section('title', 'Potansiyel Müşteriler')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Potansiyel Müşteriler</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Potansiyel müşterilerinizi yönetin</p>
        </div>
        <div class="flex items-center space-x-3">
            <a href="{{ route('admin.leads.create') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-sky-400 to-blue-600 text-white rounded-xl hover:from-sky-500 hover:to-blue-700 transition-colors">
