...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-white">Yeni Pipeline</h1>
            <p class="text-dark-400 mt-1">Satış veya talep pipeline'ı oluşturun</p>
        </div>
                ...
                <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="2" class="w-full px-4 py-2.5 bg-dark-800 border border-dark-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-primary-500">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="is_default" value="1" class="w-4 h-4 text-primary-600 bg-dark-800 border-dark-700 rounded focus:ring-primary-500">
                            <span class="text-dark-300 text-sm">Varsayılan Pipeline</span>
                        </label>
                        <label class="flex items-center gap-2">
                            <input type="checkbox" name="is_active" value="1" checked class="w-4 h-4 text-primary-600 bg-dark-800 border-dark-700 rounded focus:ring-primary-500">
                            <span class="text-dark-300 text-sm">Aktif</span>
                        </label>
                    </div>
                </div>
                <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6 space-y-3">
                    <button type="submit" class="w-full px-4 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-xl transition-colors">Kaydet</button>
                    <a href="{{ route('admin.pipelines.index') }}" class="block w-full px-4 py-2.5 bg-dark-700 hover:bg-dark-600 text-white font-medium rounded-xl transition-colors text-center">İptal</a>
                </div>
            </div>
        </div>
    </form>
