...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-white">Web Sitesi Yönetimi</h1>
            <p class="text-dark-400 mt-1">{{ $website ?? 'main' }}</p>
        </div>
        <a href="{{ route('admin.websites.index') }}" class="px-4 py-2 bg-dark-700 hover:bg-dark-600 text-white rounded-xl transition-colors flex items-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3 space-y-4">
            <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6">
                <h2 class="text-lg font-semibold text-white mb-4">Hızlı Erişim</h2>
                <div class="grid grid-cols-2 gap-4">
                    <a href="{{ route('admin.websites.pages.index', $website ?? 'main') }}" class="flex items-center gap-3 p-4 bg-dark-800 rounded-xl hover:bg-dark-700 transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-dark-400 text-xs">12 sayfa</p>
                        </div>
                    </a>
                    <a href="{{ route('admin.websites.forms.index', $website ?? 'main') }}" class="flex items-center gap-3 p-4 bg-dark-800 rounded-xl hover:bg-dark-700 transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-dark-400 text-xs">5 form</p>
                        </div>
                    </a>
                    <a href="#" class="flex items-center gap-3 p-4 bg-dark-800 rounded-xl hover:bg-dark-700 transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-dark-400 text-xs">Modern Dark</p>
                        </div>
                    </a>
                    <a href="#" target="_blank" class="flex items-center gap-3 p-4 bg-dark-800 rounded-xl hover:bg-dark-700 transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-dark-400 text-xs">Yeni sekmede aç</p>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6">
                <h2 class="text-lg font-semibold text-white mb-4">Son Form Gönderimleri</h2>
                <div class="space-y-3">
                    @foreach([
                    ...
                    <div class="flex items-center justify-between p-3 bg-dark-800 rounded-xl">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-dark-400 text-xs">{{ $submission['form'] }}</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-dark-400 text-xs">{{ $submission['time'] }}</p>
        ...
        <div class="space-y-4">
            <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-5">
                <h3 class="text-sm font-medium text-dark-400 uppercase tracking-wider mb-4">Site Bilgisi</h3>
                <div class="space-y-3 text-sm">
                    <div><span class="text-dark-400">Domain</span><p class="text-white mt-0.5">www.sirketiniz.com</p></div>
                    <div><span class="text-dark-400">SSL</span><p class="text-green-400 mt-0.5">Aktif ✓</p></div>
                    <div><span class="text-dark-400">Son Güncelleme</span><p class="text-white mt-0.5">{{ now()->format('d.m.Y') }}</p></div>
                    <div><span class="text-dark-400">Durum</span><p class="text-green-400 mt-0.5">Yayında</p></div>
                </div>
            </div>
            <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-5">
                <h3 class="text-sm font-medium text-dark-400 uppercase tracking-wider mb-3">Ayarlar</h3>
                <div class="space-y-2">
                    <button class="w-full px-3 py-2 bg-dark-700 hover:bg-dark-600 text-white text-left rounded-lg text-sm transition-colors">SEO Ayarları</button>
                    <button class="w-full px-3 py-2 bg-dark-700 hover:bg-dark-600 text-white text-left rounded-lg text-sm transition-colors">Analitik</button>
                    <button class="w-full px-3 py-2 bg-dark-700 hover:bg-dark-600 text-white text-left rounded-lg text-sm transition-colors">Domain Ayarları</button>
                </div>
            </div>
        </div>
    </div>
