...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Web Siteleri</h1>
            <p class="text-gray-500 dark:text-dark-400 mt-1">Gayrimenkul web sitelerinizi yönetin</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <!-- Demo website card -->
        <a href="{{ route('admin.websites.show', 'main') }}" class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6 hover:border-dark-600 transition-colors group">
            ...
            <p class="text-gray-500 dark:text-dark-400 text-sm mb-4">www.sirketiniz.com</p>
            <div class="grid grid-cols-3 gap-2 text-center">
                <div class="bg-gray-100 dark:bg-dark-800 rounded-lg p-2">
        ...
        <button class="bg-gray-50 dark:bg-dark-900 border border-dashed border-gray-300 dark:border-dark-600 rounded-2xl p-6 hover:border-dark-500 transition-colors flex flex-col items-center justify-center min-h-[200px] text-dark-500 hover:text-gray-500 dark:text-dark-400">
    ...
    <div class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Web Sitesi Özellikleri</h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-gray-100 dark:bg-dark-800 rounded-xl p-4">
                ...
                <p class="text-gray-500 dark:text-dark-400 text-xs mt-1">{{ $feature['desc'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
