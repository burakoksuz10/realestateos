...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-white">Yeni Takım Oluştur</h1>
            <p class="text-dark-400 mt-1">Yeni bir takım oluşturun</p>
        </div>
    ...
    <form action="{{ route('admin.teams.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Team Members -->
                <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6">
                    <h2 class="text-lg font-semibold text-white mb-6">Takım Üyeleri</h2>
                    
                    <div class="space-y-4">
                        <p class="text-dark-400 text-sm">Takımı oluşturduktan sonra üye ekleyebilirsiniz.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <!-- Leader -->
                <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6">
                    <h2 class="text-lg font-semibold text-white mb-6">Takım Lideri</h2>
                ...
                <div class="bg-dark-900 border border-dark-700/50 rounded-2xl p-6">
                    ...
                    <div>
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-dark-300">Aktif Takım</span>
                        </label>
                    </div>
                </div>
