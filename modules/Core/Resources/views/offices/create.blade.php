...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Yeni Ofis Ekle</h1>
            <p class="text-gray-500 dark:text-dark-400 mt-1">Yeni bir ofis/şube ekleyin</p>
        </div>
    ...
    <form action="{{ route('admin.offices.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required
                                ...
                                placeholder="Örn: İlkadım Şubesi">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Ofis Kodu</label>
            ...
            <div class="space-y-6">
                <!-- Manager -->
                <div class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">Yönetici</h2>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-600 dark:text-dark-300 mb-2">Ofis Yöneticisi</label>
                        <select name="manager_id" class="w-full px-4 py-2.5 bg-gray-100 dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-primary-500">
                            <option value="">Seçiniz</option>
                            @if(isset($users))
                ...
                <div class="bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700/50 rounded-2xl p-6">
                    ...
                    <div>
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-gray-600 dark:text-dark-300">Aktif Ofis</span>
                        </label>
                    </div>
                </div>
